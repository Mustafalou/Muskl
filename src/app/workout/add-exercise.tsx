...
import { MUSCLE_GROUPS, filterExercises, type CatalogExercise } from '@/constants/exercise-catalog';
...
export default function AddExerciseScreen() {
  ...
  const results = filterExercises(query, muscle);
    ...
    <ThemedView style={styles.flex}>
      <SafeAreaView style={styles.flex} edges={['bottom']}>
        ...
        <ScrollView
          ...
          <Chip label="Tous" active={muscle === null} onPress={() => setMuscle(null)} />
            ...
            trimmedQuery && !hasExactMatch ? (
              <Pressable
                ...
                <ThemedText themeColor="tint">
                  Ajouter « {trimmedQuery} » comme exercice personnalisé
                </ThemedText>
              </Pressable>
            ) : null
          }
